...
(function () {
  'use strict';
  var L = {
    en: { title: 'Alerts', on: 'On — you’ll get a ping when YOUR report is verified; admins get new reports.', off: 'Turn on to get notified the moment a clean-up you reported is verified ✅ (admins also get new reports).', unsupported: 'Push notifications aren’t available in this browser.', needlogin: 'Log in to get notified about your reports.', needsetup: 'Alerts aren’t configured on the server yet (see PUSH_SETUP.md).', needperm: 'Notifications are blocked — allow them in site settings, then retry.', btn_on: '🔔 Turn on alerts', btn_off: '🔕 Turn off alerts', btn_test: 'Send me a test alert', sent: 'Test alert sent — check your notifications!', city: 'Zone' },
    fr: { title: 'Alertes', on: 'Activé — vous recevez un ping quand VOTRE signalement est vérifié ; les admins reçoivent les nouveaux.', off: 'Activez pour être prévenu dès qu’un nettoyage que vous avez signalé est vérifié ✅ (les admins reçoivent les nouveaux signalements).', unsupported: 'Les notifications push ne sont pas dispo dans ce navigateur.', needlogin: 'Connectez-vous pour être notifié de vos signalements.', needsetup: 'Les alertes ne sont pas configurées côté serveur (voir PUSH_SETUP.md).', needperm: 'Notifs bloquées — autorisez-les dans les réglages du site.', btn_on: '🔔 Activer les alertes', btn_off: '🔕 Désactiver les alertes', btn_test: 'M’envoyer une alerte test', sent: 'Alerte test envoyée — vérifiez vos notifs !', city: 'Zone' },
    ar: { title: 'التنبيهات', on: 'مفعَّلة — يصلك تنبيه عند التحقق من بلاغك؛ يصل المشرفين البلاغات الجديدة.', off: 'فعّل لتصلك رسالة لحظة التحقق من تنظيف بلّغت عنه ✅ (المشرفون يستقبلون البلاغات الجديدة أيضًا).', unsupported: 'الإشعارات الفورية غير متاحة في هذا المتصفح.', needlogin: 'سجّل الدخول لتصلك تنبيهات بلاغاتك.', needsetup: 'التنبيهات غير مهيأة على الخادم بعد (راجع PUSH_SETUP.md).', needperm: 'الإشعارات محظورة — اسمح بها في إعدادات الموقع.', btn_on: '🔔 تفعيل التنبيهات', btn_off: '🔕 إيقاف التنبيهات', btn_test: 'أرسل لي تنبيهًا تجريبيًا', sent: 'أُرسل التنبيه التجريبي — راجع إشعاراتك!', city: 'المنطقة' },
  };
