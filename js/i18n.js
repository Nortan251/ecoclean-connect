...
(function () {
  const I18N = {
    en: {
      ...
      impact_cat_title: 'Where we’re winning', impact_gallery_title: 'Verified Clean-ups Gallery', impact_step1_t: 'Citizens report', impact_step1_d: 'Anyone drops a pin, snaps a photo and picks a category — in about 30 seconds, from any phone.', impact_step2_t: 'Your association verifies', impact_step2_d: 'Your team logs in, sees only your city, confirms clean-ups with a before/after photo and rewards the citizen.', impact_step3_t: 'The city sees the impact', impact_step3_d: 'Every verified clean-up updates this dashboard live — proof you can show funders, the municipality and the press.', impact_demo_note: 'Live demo: the before/after gallery shows real clean-up photos once the platform runs with a partner — the verification flow that feeds it is already built.',
      ...
      impact_net: '{cities} cities · {orgs} associations on the network', impact_net_link: 'See the network →', impact_updated: 'Last updated', impact_net_none: 'No partner associations on the network yet',
    ...
    fr: {
      ...
      impact_net: '{cities} villes · {orgs} associations sur le réseau', impact_net_link: 'Voir le réseau →', impact_updated: 'Dernière mise à jour', impact_net_none: 'Aucune association partenaire sur le réseau pour l’instant',
    ...
    ar: {
      ...
      impact_cat_title: 'حيث ننتصر', impact_gallery_title: 'معرض عمليات التنظيف المؤكدة', impact_step1_t: 'المواطنون يبلّغون', impact_step1_d: 'أي شخص يضع دبوسًا ويلتقط صورة ويختار فئة — في نحو 30 ثانية، من أي هاتف.', impact_step2_t: 'جمعيتك تتحقّق', impact_step2_d: 'فريقك يسجّل الدخول، يرى مدينته فقط، يؤكّد عمليات التنظيف بصورة قبل/بعد ويكافئ المواطن.', impact_step3_t: 'المدينة ترى الأثر', impact_step3_d: 'كل عملية تنظيف متحققة تحدّث هذه اللوحة مباشرة — دليل تُظهره للمموّلين والبلدية والصحافة.', impact_demo_note: 'عرض تجريبي: معرض قبل/بعد سيعرض صور تنظيف حقيقية حين تعمل المنصة مع شريك — تدفق التحقق الذي يغذّيه مبنيّ بالفعل.',
      ...
      impact_net: '{cities} مدن · {orgs} جمعيات على الشبكة', impact_net_link: '← عرض الشبكة', impact_updated: 'آخر تحديث', impact_net_none: 'لا جمعيات شريكة على الشبكة بعد',
