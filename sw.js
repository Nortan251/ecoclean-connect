...
const SHELL = 'ecoclean-shell-v3';   // same-origin app shell (pre-cached on install)
const RUNTIME = 'ecoclean-runtime-v3'; // CDN libs + live-data cache + misc runtime gets
const TILES = 'ecoclean-tiles-v3';   // OSM tiles, size-bounded
...
// time would abort the whole installation. CDN libs are cached lazily at runtime.
const SHELL_ASSETS = [
  ...
  './js/map-sync.js', './js/install-prompt.js',
