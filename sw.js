...
const SHELL = 'ecoclean-shell-v8';   // same-origin app shell (pre-cached on install)
const RUNTIME = 'ecoclean-runtime-v8'; // CDN libs + live-data cache + misc runtime gets
const TILES = 'ecoclean-tiles-v8';   // OSM tiles, size-bounded
...
const SHELL_ASSETS = [
  ...
  './js/map-sync.js', './js/cluster.js', './js/realtime.js', './js/install-prompt.js', './js/offline-submit.js', './js/thankyou.js', './js/share.js', './js/offline-banner.js', './js/photo-trust.js', './js/a11y.js', './js/export-data.js',
